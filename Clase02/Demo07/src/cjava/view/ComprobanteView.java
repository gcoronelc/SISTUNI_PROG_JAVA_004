...
import cjava.model.Boleta;
import cjava.model.Comprobante;
import cjava.model.Factura;
...
public class ComprobanteView extends javax.swing.JDialog {
    ...
    private void procesar() {
        ...
        Item[] res = com.Procesar(Double.parseDouble(txtTotal.getText()));
        // mostrar boleta
        DefaultTableModel tabla = (DefaultTableModel) tblComprobante.getModel();
        tabla.setRowCount(0);
        for (Item x : res) {
            Object[] fila = {x.getConcepto(), x.getImporte()};
            tabla.addRow(fila);
        }
    }
}
